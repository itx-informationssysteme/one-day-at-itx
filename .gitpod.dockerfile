...
# RUN sudo apt-get update && sudo apt-get upgrade -y && sudo apt-get install -y software-properties-common gnupg2 dirmngr apt-transport-https php-xmlrpc php-pdo-mysql wget
